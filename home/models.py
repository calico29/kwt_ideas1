...
class Application(models.Model):
    ...
    patents_links = models.TextField(blank=True, null=True, verbose_name="Статьи, доклады, патенты, «ноу-хау» (при наличии)")
    scientific_group = models.CharField(max_length=255, blank=True, null=True, verbose_name="Научная группа")
    pni_project = models.CharField(max_length=255, blank=True, null=True, verbose_name="Проект ПНИ")
    implementation_date = models.DateField(blank=True, null=True, verbose_name="Дата внедрения инновации")
    development_basis = models.TextField(blank=True, null=True, verbose_name="Основание для разработки инновации")
    customer = models.CharField(max_length=255, blank=True, null=True, verbose_name="Заказчик")
    development_description = models.TextField(blank=True, null=True, verbose_name="Описание и характеристики разработки")
    comparison_advantages = models.TextField(blank=True, null=True, verbose_name="Сравнительные преимущества")
    replication_assessment = models.TextField(blank=True, null=True, verbose_name="Оценка возможности тиражирования")
